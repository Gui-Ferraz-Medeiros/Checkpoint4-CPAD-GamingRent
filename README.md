Aqui está o arquivo **`README.md`** completo e atualizado, com a seção de **Estrutura principal** exatamente igual à árvore de arquivos exibida no seu print do VS Code:
